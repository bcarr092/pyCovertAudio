...
def initialize_debug_info():
  ...
  if( args.verbosity == 'trace' ):
    pyCovertAudio_lib.cpc_log_set_log_level( pyCovertAudio_lib.CPC_LOG_LEVEL_TRACE )
  elif( args.verbosity == 'debug' ):
    pyCovertAudio_lib.cpc_log_set_log_level( pyCovertAudio_lib.CPC_LOG_LEVEL_DEBUG )
  elif( args.verbosity == 'info' ):
    pyCovertAudio_lib.cpc_log_set_log_level( pyCovertAudio_lib.CPC_LOG_LEVEL_INFO )
  elif( args.verbosity == 'warning' ):
    pyCovertAudio_lib.cpc_log_set_log_level( pyCovertAudio_lib.CPC_LOG_LEVEL_WARN )
  elif( args.verbosity == 'error' ):
    pyCovertAudio_lib.cpc_log_set_log_level( pyCovertAudio_lib.CPC_LOG_LEVEL_ERROR )
  elif( args.verbosity == 'none' ):
    pyCovertAudio_lib.cpc_log_set_log_level( pyCovertAudio_lib.CPC_LOG_LEVEL_NO_LOGGING )
  else:
    parser.print_help()
